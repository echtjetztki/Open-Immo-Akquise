            ...
            <div className="glass-card p-6 space-y-6 overflow-hidden relative min-h-[550px] flex flex-col">
                        ...
                        <div className="glass-card p-6 md:p-8 max-w-md w-full shadow-2xl border-primary/30 text-center space-y-5 !transform-none">
                            ...
                            >
                             ...
                             <div className="pt-4 border-t border-border/50 flex flex-col gap-3">
                                <p className="text-xs font-bold uppercase tracking-wider text-muted-foreground">Noch keinen Lizenzschlüssel?</p>
                                <a 
                                ...
                                >
                                    ...
                                    <span className="text-white font-bold text-sm">Premium direkt buchen (Stripe)</span>
                                </a>
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                            Webhook-Details & Zugangsdaten für Automatisierungen
                        </p>
                    </div>
                </div>
                ...
                <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4 border-t border-primary/10">
                             <button
                                onClick={handleSync}
                                disabled={syncing || isReadOnlyDemo}
                            ...
                            <button
                                ...
                                disabled={supabaseTesting || isReadOnlyDemo}
                                className="btn-secondary flex items-center justify-center gap-2"
                                suppressHydrationWarning
                            >
