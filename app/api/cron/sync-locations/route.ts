...
import { blockDemoWrites, requireN8nActivation, requireSessionUser } from '@/lib/access';
...
export async function GET(request: Request) {
    ...
    try {
        ...
        const n8nActivationBlock = await requireN8nActivation(request);
        if (n8nActivationBlock) {
            return n8nActivationBlock;
        }
