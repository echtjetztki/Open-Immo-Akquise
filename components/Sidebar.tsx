...
import { LayoutDashboard, PlusCircle, TrendingUp, Users, Menu, X, BarChart3, MessageSquare, LogOut, UserCircle } from 'lucide-react';
...
export function Sidebar() {
    ...
    const adminItems = [
        ...
        { name: 'CRM & Rechnungen', href: '/crm', icon: Users },
        { name: 'Benutzer-Verwaltung', href: '/users', icon: UserCircle },
    ...
    const userItems = [
        ...
        { name: 'Profil & Passwort', href: settingsPath, icon: UserCircle },
    ];
