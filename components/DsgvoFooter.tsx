...
export function DsgvoFooter() {
    ...
    return (
        <>
            <footer className="w-full border-t border-primary/10 bg-background/80 backdrop-blur-sm mt-4 pt-3 pb-[calc(env(safe-area-inset-bottom)+3.25rem)] lg:pb-8 px-4 lg:pl-60">
