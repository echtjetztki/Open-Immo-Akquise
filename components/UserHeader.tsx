                ...
                <div className="flex md:hidden items-center gap-1">
                    <Link
                        ...
                        className={clsx(
                            ...
                            isDashboard ? 'text-primary bg-primary/10' : 'text-muted-foreground'
                        )}
                    ...
                    <Link
                        ...
                        className={clsx(
                            'p-2 rounded-xl transition-all',
                            isSettings ? 'text-primary bg-primary/10' : 'text-muted-foreground'
                        )}
                    ...
                    {isAgent && (
                        <Link
                            ...
                            className={clsx(
                                'p-2 rounded-xl transition-all',
                                isReferrals ? 'text-primary bg-primary/10' : 'text-muted-foreground'
                            )}
                    ...
                    <button
                        type="button"
                        onClick={handleLogout}
                        className="p-2 text-muted-foreground hover:text-error transition-all"
                        title={t('nav.logout')}
                    >
                        <LogOut className="h-5 w-5" />
                    </button>
