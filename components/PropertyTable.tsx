                                    ...
                                    <div className="flex flex-col gap-1.5">
                                        ...
                                        {updatingStatus === property.id ? (
                                            ...
                                            <select
                                                ...
                                                className="text-[10px] font-black px-1.5 py-1 rounded-lg border border-primary/10 bg-white/50 hover:bg-white hover:border-primary/30 transition-all cursor-pointer w-[170px] focus:ring-2 focus:ring-primary/10 outline-none shadow-sm"
                                                title="Status ändern"
                                            >
                        ...
                        <div className="pt-2">
                            {updatingStatus === property.id ? (
                                ...
                                <select
                                    value={property.status}
                                    onChange={(e) => handleStatusChange(property.id, e.target.value as PropertyStatus)}
                                    className="w-full text-base font-bold p-3 rounded-xl border-2 border-primary/20 bg-white text-foreground hover:border-primary focus:border-primary focus:ring-4 focus:ring-primary/20 appearance-none shadow-sm transition-all text-center cursor-pointer"
                                    title="Status ändern"
                                >
