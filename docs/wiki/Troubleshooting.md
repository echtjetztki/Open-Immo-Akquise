...
3. Ist in Supabase ein aktiver Code in `license_keys` vorhanden und ist `license_installations` beschreibbar?

Hinweis:
- Optionaler Demo-Bypass nur mit `LICENSE_ALLOW_DEMO_BYPASS=true`.
