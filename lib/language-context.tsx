...
const translations: Record<string, Record<Language, string>> = {
    ...
    // ============ CUSTOMERS PAGE ============
    'cust.title': { de: 'Kunden', en: 'Customers', bg: 'Клиенти' },
    'cust.subtitle': { de: 'Kundenstamm verwalten', en: 'Manage customers', bg: 'Управление на клиенти' },
    'cust.new': { de: 'Neuer Kunde', en: 'New Customer', bg: 'Нов клиент' },
    'cust.search_placeholder': { de: 'Kunden suchen...', en: 'Search customers...', bg: 'Търсене на клиенти...' },
    'cust.edit_title': { de: 'Kunde bearbeiten', en: 'Edit Customer', bg: 'Редактиране на клиент' },
    'cust.create_title': { de: 'Neuen Kunden anlegen', en: 'Create New Customer', bg: 'Създаване на нов клиент' },
    'cust.label_name': { de: 'Name *', en: 'Name *', bg: 'Име *' },
    'cust.label_company': { de: 'Firma', en: 'Company', bg: 'Фирма' },
    'cust.label_email': { de: 'E-Mail', en: 'Email', bg: 'Имейл' },
    'cust.label_phone': { de: 'Telefon', en: 'Phone', bg: 'Телефон' },
    'cust.label_address': { de: 'Adresse', en: 'Address', bg: 'Адрес' },
    'cust.placeholder_name': { de: 'Max Mustermann', en: 'John Doe', bg: 'Иван Иванов' },
    'cust.placeholder_company': { de: 'Firma GmbH', en: 'Company Ltd.', bg: 'Фирма ООД' },
    'cust.placeholder_email': { de: 'max@beispiel.de', en: 'john@example.com', bg: 'ivan@example.bg' },
    'cust.placeholder_phone': { de: '+49 ...', en: '+1 ...', bg: '+359 ...' },
    'cust.placeholder_address': { de: 'Strasse, PLZ Ort', en: 'Street, ZIP City', bg: 'Улица, Пощенски код Град' },
    'cust.btn_cancel': { de: 'Abbrechen', en: 'Cancel', bg: 'Отказ' },
    'cust.btn_save': { de: 'Speichern', en: 'Save', bg: 'Запази' },
    'cust.btn_create': { de: 'Anlegen', en: 'Create', bg: 'Създай' },
    'cust.btn_edit': { de: 'Bearbeiten', en: 'Edit', bg: 'Редактирай' },
    'cust.btn_delete': { de: 'Loeschen', en: 'Delete', bg: 'Изтрий' },
    'cust.confirm_delete': { de: 'Kunde wirklich loeschen?', en: 'Really delete this customer?', bg: 'Наистина ли искате да изтриете този клиент?' },
    'cust.loading': { de: 'Lade Kunden...', en: 'Loading customers...', bg: 'Зареждане на клиенти...' },
    'cust.no_results': { de: 'Keine Kunden gefunden.', en: 'No customers found.', bg: 'Няма намерени клиенти.' },
    'cust.empty': { de: 'Noch keine Kunden angelegt.', en: 'No customers yet.', bg: 'Все още няма клиенти.' },
    ...
    // ============ ARTICLES ============
    'art.title': { de: 'Artikel', en: 'Articles', bg: 'Артикули' },
    'art.subtitle': { de: 'Artikelstamm verwalten', en: 'Manage article master data', bg: 'Управление на артикули' },
    'art.new': { de: 'Neuer Artikel', en: 'New Article', bg: 'Нов артикул' },
    'art.search': { de: 'Artikel suchen...', en: 'Search articles...', bg: 'Търсене на артикули...' },
    'art.edit_title': { de: 'Artikel bearbeiten', en: 'Edit Article', bg: 'Редактиране на артикул' },
    'art.create_title': { de: 'Neuen Artikel anlegen', en: 'Create New Article', bg: 'Създаване на нов артикул' },
    'art.label_title': { de: 'Titel', en: 'Title', bg: 'Заглавие' },
    'art.label_description': { de: 'Beschreibung', en: 'Description', bg: 'Описание' },
    'art.label_price': { de: 'Preis (EUR)', en: 'Price (EUR)', bg: 'Цена (EUR)' },
    'art.label_unit': { de: 'Einheit', en: 'Unit', bg: 'Единица' },
    'art.placeholder_title': { de: 'Artikelname', en: 'Article name', bg: 'Име на артикул' },
    'art.placeholder_description': { de: 'Optionale Beschreibung', en: 'Optional description', bg: 'Незадължително описание' },
    'art.cancel': { de: 'Abbrechen', en: 'Cancel', bg: 'Отказ' },
    'art.save': { de: 'Speichern', en: 'Save', bg: 'Запази' },
    'art.create': { de: 'Anlegen', en: 'Create', bg: 'Създай' },
    'art.loading': { de: 'Lade Artikel...', en: 'Loading articles...', bg: 'Зареждане на артикули...' },
    'art.th_article': { de: 'Artikel', en: 'Article', bg: 'Артикул' },
    'art.th_description': { de: 'Beschreibung', en: 'Description', bg: 'Описание' },
    'art.th_unit': { de: 'Einheit', en: 'Unit', bg: 'Единица' },
    'art.th_price': { de: 'Preis', en: 'Price', bg: 'Цена' },
    'art.th_actions': { de: 'Aktionen', en: 'Actions', bg: 'Действия' },
    'art.no_results': { de: 'Keine Artikel gefunden.', en: 'No articles found.', bg: 'Няма намерени артикули.' },
    'art.empty': { de: 'Noch keine Artikel angelegt.', en: 'No articles created yet.', bg: 'Все още няма създадени артикули.' },
    'art.btn_edit': { de: 'Bearbeiten', en: 'Edit', bg: 'Редактирай' },
    'art.btn_delete': { de: 'Loeschen', en: 'Delete', bg: 'Изтрий' },
    'art.confirm_delete': { de: 'Artikel wirklich loeschen?', en: 'Really delete this article?', bg: 'Наистина ли да се изтрие артикулът?' },
    'art.unit_stueck': { de: 'Stück', en: 'Piece', bg: 'Брой' },
    'art.unit_stunde': { de: 'Stunde', en: 'Hour', bg: 'Час' },
    'art.unit_pauschal': { de: 'Pauschal', en: 'Flat rate', bg: 'Паушал' },
    'art.unit_kg': { de: 'kg', en: 'kg', bg: 'кг' },
    'art.unit_m': { de: 'm', en: 'm', bg: 'м' },
    'art.unit_m2': { de: 'm²', en: 'm²', bg: 'м²' },

    // ============ INVOICES PAGE (inv.) ============
    // Page header
    'inv.title': { de: 'Dokumente', en: 'Documents', bg: 'Документи' },
    'inv.subtitle': { de: 'Rechnungen, Angebote & Lieferscheine', en: 'Invoices, Quotes & Delivery Notes', bg: 'Фактури, оферти и товарителници' },
    'inv.new_document': { de: 'Neues Dokument', en: 'New Document', bg: 'Нов документ' },

    // Search & Filters
    'inv.search': { de: 'Suchen...', en: 'Search...', bg: 'Търсене...' },
    'inv.all_types': { de: 'Alle Typen', en: 'All Types', bg: 'Всички типове' },
    'inv.all_statuses': { de: 'Alle Status', en: 'All Statuses', bg: 'Всички статуси' },

    // Document types
    'inv.doc_type.Rechnung': { de: 'Rechnung', en: 'Invoice', bg: 'Фактура' },
    'inv.doc_type.Angebot': { de: 'Angebot', en: 'Quote', bg: 'Оферта' },
    'inv.doc_type.Lieferschein': { de: 'Lieferschein', en: 'Delivery Note', bg: 'Товарителница' },
    'inv.doc_type.Liefers.': { de: 'Liefers.', en: 'Del. Note', bg: 'Товарит.' },

    // Statuses
    'inv.status.Entwurf': { de: 'Entwurf', en: 'Draft', bg: 'Чернова' },
    'inv.status.Gesendet': { de: 'Gesendet', en: 'Sent', bg: 'Изпратено' },
    'inv.status.Bezahlt': { de: 'Bezahlt', en: 'Paid', bg: 'Платено' },
    'inv.status.Storniert': { de: 'Storniert', en: 'Cancelled', bg: 'Анулирано' },
    'inv.status.Klage': { de: 'Klage', en: 'Lawsuit', bg: 'Дело' },
    'inv.status.Inkasso': { de: 'Inkasso', en: 'Collection', bg: 'Инкасо' },

    // Form
    'inv.create_document': { de: 'Neues Dokument erstellen', en: 'Create New Document', bg: 'Създаване на нов документ' },
    'inv.customer_from_db': { de: 'Kunde aus Stammdaten', en: 'Customer from Database', bg: 'Клиент от базата данни' },
    'inv.manual_entry': { de: '-- Manuell eingeben --', en: '-- Enter manually --', bg: '-- Ръчно въвеждане --' },
    'inv.name': { de: 'Name *', en: 'Name *', bg: 'Име *' },
    'inv.email': { de: 'E-Mail', en: 'Email', bg: 'Имейл' },
    'inv.address': { de: 'Adresse', en: 'Address', bg: 'Адрес' },
    'inv.name_placeholder': { de: 'Max Mustermann', en: 'John Doe', bg: 'Иван Иванов' },
    'inv.email_placeholder': { de: 'max@beispiel.de', en: 'john@example.com', bg: 'ivan@primer.bg' },
    'inv.address_placeholder': { de: 'Strasse 1, PLZ Ort', en: 'Street 1, ZIP City', bg: 'Улица 1, Пощенски код Град' },

    // Line items
    'inv.positions': { de: 'Positionen', en: 'Line Items', bg: 'Позиции' },
    'inv.article': { de: 'Artikel', en: 'Article', bg: 'Артикул' },
    'inv.please_select': { de: '-- Bitte waehlen --', en: '-- Please select --', bg: '-- Моля изберете --' },
    'inv.quantity': { de: 'Menge', en: 'Quantity', bg: 'Количество' },
    'inv.add': { de: 'Hinzufuegen', en: 'Add', bg: 'Добави' },
    'inv.position': { de: 'Position', en: 'Item', bg: 'Позиция' },
    'inv.unit_price': { de: 'Einzel', en: 'Unit', bg: 'Единична' },
    'inv.total': { de: 'Gesamt', en: 'Total', bg: 'Общо' },
    'inv.sum': { de: 'Summe:', en: 'Total:', bg: 'Сума:' },
    'inv.cancel': { de: 'Abbrechen', en: 'Cancel', bg: 'Отказ' },
    'inv.save': { de: 'Speichern', en: 'Save', bg: 'Запази' },

    // Card view
    'inv.amount': { de: 'Betrag', en: 'Amount', bg: 'Сума' },
    'inv.date': { de: 'Datum', en: 'Date', bg: 'Дата' },
    'inv.change_status': { de: 'Status aendern:', en: 'Change status:', bg: 'Промяна на статус:' },
    'inv.loading': { de: 'Lade Dokumente...', en: 'Loading documents...', bg: 'Зареждане на документи...' },
    'inv.no_results': { de: 'Keine Dokumente gefunden.', en: 'No documents found.', bg: 'Няма намерени документи.' },
    'inv.no_documents': { de: 'Noch keine Dokumente erstellt.', en: 'No documents created yet.', bg: 'Все още няма създадени документи.' },
    'inv.prepayment': { de: 'Vorkasse', en: 'Prepayment', bg: 'Предплащане' },

    // Action messages
    'inv.status_changed': { de: 'Status geaendert', en: 'Status changed', bg: 'Статусът е променен' },
    'inv.confirm_delete': { de: 'Dokument wirklich loeschen?', en: 'Really delete this document?', bg: 'Наистина ли искате да изтриете документа?' },
    'inv.deleted': { de: 'Dokument geloescht', en: 'Document deleted', bg: 'Документът е изтрит' },
    'inv.email_sent': { de: 'E-Mail gesendet!', en: 'Email sent!', bg: 'Имейлът е изпратен!' },
    'inv.error': { de: 'Fehler', en: 'Error', bg: 'Грешка' },
    'inv.email_failed': { de: 'E-Mail-Versand fehlgeschlagen', en: 'Email sending failed', bg: 'Неуспешно изпращане на имейл' },

    // Email modal
    'inv.send_via_email': { de: 'per E-Mail senden', en: 'send via Email', bg: 'изпрати по имейл' },
    'inv.to': { de: 'An:', en: 'To:', bg: 'До:' },
    'inv.subject': { de: 'Betreff', en: 'Subject', bg: 'Тема' },
    'inv.message_optional': { de: 'Nachricht (optional)', en: 'Message (optional)', bg: 'Съобщение (незадължително)' },
    'inv.message_placeholder': { de: 'Optionale persoenliche Nachricht...', en: 'Optional personal message...', bg: 'Незадължително лично съобщение...' },
    'inv.add_payment_button': { de: 'Zahlungsbutton einfuegen', en: 'Add payment button', bg: 'Добави бутон за плащане' },
    'inv.none': { de: 'Keiner', en: 'None', bg: 'Без' },
    'inv.sending': { de: 'Sendet...', en: 'Sending...', bg: 'Изпраща се...' },
    'inv.send_now': { de: 'Jetzt senden', en: 'Send now', bg: 'Изпрати сега' },

    // PDF texts
    'inv.pdf.your_company': { de: 'Ihr Unternehmen', en: 'Your Company', bg: 'Вашата фирма' },
    'inv.pdf.unknown': { de: 'Unbekannt', en: 'Unknown', bg: 'Неизвестен' },
    'inv.pdf.invoice_nr': { de: 'Rechnungsnr.', en: 'Invoice No.', bg: 'Фактура №' },
    'inv.pdf.quote_nr': { de: 'Angebotsnr.', en: 'Quote No.', bg: 'Оферта №' },
    'inv.pdf.delivery_nr': { de: 'Lieferscheinnr.', en: 'Delivery Note No.', bg: 'Товарителница №' },
    'inv.pdf.date': { de: 'Datum:', en: 'Date:', bg: 'Дата:' },
    'inv.pdf.due_date': { de: 'Faellig bis:', en: 'Due by:', bg: 'Краен срок:' },
    'inv.pdf.salutation': { de: 'Sehr geehrte Damen und Herren,', en: 'Dear Sir or Madam,', bg: 'Уважаеми дами и господа,' },
    'inv.pdf.invoice_intro': { de: 'wir erlauben uns, Ihnen folgende Positionen in Rechnung zu stellen:', en: 'we would like to invoice you for the following items:', bg: 'бихме желали да Ви фактурираме следните позиции:' },
    'inv.pdf.quote_intro': { de: 'gerne unterbreiten wir Ihnen folgendes Angebot:', en: 'we are pleased to submit the following quote:', bg: 'с удоволствие Ви представяме следната оферта:' },
    'inv.pdf.delivery_intro': { de: 'Lieferung an oben genannte Adresse:', en: 'Delivery to the above address:', bg: 'Доставка до горния адрес:' },
    'inv.pdf.pos': { de: 'Pos.', en: 'Pos.', bg: 'Поз.' },
    'inv.pdf.description': { de: 'Beschreibung', en: 'Description', bg: 'Описание' },
    'inv.pdf.qty': { de: 'Menge', en: 'Qty', bg: 'К-во' },
    'inv.pdf.unit_price': { de: 'Einzelpreis', en: 'Unit Price', bg: 'Ед. цена' },
    'inv.pdf.total': { de: 'Gesamt', en: 'Total', bg: 'Общо' },
    'inv.pdf.service': { de: 'Leistung / Produkt', en: 'Service / Product', bg: 'Услуга / Продукт' },
    'inv.pdf.net_amount': { de: 'Nettobetrag:', en: 'Net amount:', bg: 'Нето сума:' },
    'inv.pdf.vat': { de: 'zzgl. 19% MwSt:', en: 'plus 19% VAT:', bg: 'плюс 19% ДДС:' },
    'inv.pdf.total_amount': { de: 'Gesamtbetrag:', en: 'Total amount:', bg: 'Обща сума:' },
    'inv.pdf.payment_methods': { de: 'Zahlungsarten:', en: 'Payment Methods:', bg: 'Начини на плащане:' },
    'inv.pdf.bank_transfer': { de: 'Vorkasse / Bankueberweisung:', en: 'Prepayment / Bank Transfer:', bg: 'Предплащане / Банков превод:' },
    'inv.pdf.recipient': { de: 'Empfaenger', en: 'Recipient', bg: 'Получател' },
    'inv.pdf.bank': { de: 'Bank', en: 'Bank', bg: 'Банка' },
    'inv.pdf.reference': { de: 'Verwendungszweck', en: 'Reference', bg: 'Основание' },
    'inv.pdf.payment_term_days': { de: 'Zahlungsziel', en: 'Payment term', bg: 'Срок за плащане' },
    'inv.pdf.days': { de: 'Tage', en: 'days', bg: 'дни' },
    'inv.pdf.until': { de: 'bis', en: 'until', bg: 'до' },
    'inv.pdf.scan_qr': { de: 'QR-Code scannen', en: 'Scan QR code', bg: 'Сканирай QR код' },
    'inv.pdf.to_pay': { de: 'zum Bezahlen', en: 'to pay', bg: 'за плащане' },
    'inv.pdf.online_payment': { de: 'Online-Zahlung (Kreditkarte / SEPA):', en: 'Online Payment (Credit Card / SEPA):', bg: 'Онлайн плащане (Кредитна карта / SEPA):' },
    'inv.pdf.online_payment_text': { de: 'Bezahlen Sie bequem online ueber den Zahlungslink in der E-Mail.', en: 'Pay conveniently online via the payment link in the email.', bg: 'Платете удобно онлайн чрез линка за плащане в имейла.' },
    'inv.pdf.paypal_text': { de: 'Bezahlen Sie per PayPal ueber den Zahlungslink in der E-Mail.', en: 'Pay via PayPal using the payment link in the email.', bg: 'Платете чрез PayPal с линка за плащане в имейла.' },
    'inv.pdf.invoice_closing': { de: 'Bitte ueberweisen Sie den Gesamtbetrag unter Angabe der Rechnungsnummer.', en: 'Please transfer the total amount quoting the invoice number.', bg: 'Моля, преведете общата сума, като посочите номера на фактурата.' },
    'inv.pdf.thank_you': { de: 'Vielen Dank fuer Ihr Vertrauen!', en: 'Thank you for your trust!', bg: 'Благодарим Ви за доверието!' },
    'inv.pdf.quote_validity': { de: 'Dieses Angebot ist 30 Tage gueltig. Bei Fragen stehen wir Ihnen gerne zur Verfuegung.', en: 'This quote is valid for 30 days. Please do not hesitate to contact us with any questions.', bg: 'Тази оферта е валидна 30 дни. Не се колебайте да се свържете с нас при въпроси.' },
    'inv.pdf.quote_closing': { de: 'Wir freuen uns auf Ihre Rueckmeldung!', en: 'We look forward to your response!', bg: 'Очакваме Вашия отговор!' },
    'inv.pdf.regards': { de: 'Mit freundlichen Gruessen', en: 'Kind regards', bg: 'С уважение' },
    'inv.pdf.agb_title': { de: 'Allgemeine Geschaeftsbedingungen', en: 'General Terms and Conditions', bg: 'Общи условия' },
    'inv.pdf.privacy_title': { de: 'Datenschutzhinweis', en: 'Privacy Notice', bg: 'Известие за поверителност' },
    'inv.pdf.withdrawal_title': { de: 'Widerrufsbelehrung', en: 'Cancellation Policy', bg: 'Политика за отказ' },
};
