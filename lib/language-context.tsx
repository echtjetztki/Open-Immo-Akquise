...
const translations: Record<string, Record<Language, string>> = {
    ...
    'crm.due_date': { de: 'Faellig am', en: 'Due date', bg: 'Дата на падеж' },
    ...
    'crm.add': { de: 'Hinzufuegen', en: 'Add', bg: 'Добави' },
    ...
    'crm.delete': { de: 'Loeschen', en: 'Delete', bg: 'Изтрий' },
    'crm.delete_confirm': { de: 'Dokument wirklich loeschen?', en: 'Really delete document?', bg: 'Наистина ли да се изтрие документът?' },
